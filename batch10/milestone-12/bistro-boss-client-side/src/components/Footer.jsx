    ...
    return (
        <footer className="text-neutral-content">
            <div className="flex flex-col md:flex-row">
                <div className="w-full py-10 bg-[#1f2937] flex flex-col justify-center items-center text-center ">
            ...
            <div className="footer footer-center bg-black text-white p-4">
                <div>
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by Bistro Boss Industries Ltd</p>
                </div>
            </div>
        </footer>
    );
