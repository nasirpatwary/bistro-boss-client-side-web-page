        ...
        <div className="flex px-4 md:px-0 md:gap-10">
            ...
            <div className="min-h-screen hidden  lg:block bg-[#d1a054] md:w-52 p-2 lg:p-4 lg:w-64">
                ...
                <ul className="menu space-y-3 text-base-content">
                    {/* Sidebar content here */}
                    {
                        isAdmin ?
                            <>
                                <NavLink to="/dashboard/adminHome" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiFillHome />Addmin Home</NavLink>
                                <NavLink to="/dashboard/addItems" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiOutlineMenuFold />AddItems</NavLink>
                                <NavLink to="/dashboard/manageItems" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiOutlineMenuFold />Manage Items</NavLink>
                                <NavLink to="/dashboard/manageBookings" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiOutlineMenuFold />Manage Bookings </NavLink>
                            ...
                            :
                            <>
                                <NavLink to="/dashboard/userHome" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiFillHome />User Home</NavLink>
                                <NavLink to="/dashboard/reservation
                                " className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiOutlineMenuFold />Reservation</NavLink>
                                <NavLink to="/dashboard/paymentHistory" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiOutlineMenuFold />Payment History</NavLink>
                                ...
                                <NavLink to="/dashboard/review" className={({ isPending, isActive }) => `whitespace-nowrap flex items-center gap-2 md:text-xl ${isPending ? <LoadingSpinner /> : isActive ? "text-white" : undefined}`}><AiOutlineMenuFold />Add Review</NavLink>
                ...
                <div className="mt-16">
                    {
                        user ?
                            <>
                                <button onClick={signOutUser} className="flex text-xl items-center gap-2"><CiLogin size={20} /> Log Out</button>
                            </>
                            :
                            <>
            ...
            <div className="lg:hidden z-10">
                ...
                <div className="drawer-content">
                    {/* Page content here */}
                    <label htmlFor="my-drawer" className="btn drawer-button absolute">Side Menu<AiOutlineMenuFold size={20} /></label>
                </div>
